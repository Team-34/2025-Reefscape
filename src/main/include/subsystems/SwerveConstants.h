...
namespace t34 {
    ...
    */
    ...
    constexpr int ID_LEFT_FWD_DRIVE     {29};
    constexpr int ID_LEFT_FWD_STEER     {30};
    constexpr int ID_LEFT_FWD_CANCODER  {31};
    ...
    constexpr int ID_RIGHT_AFT_DRIVE    {23};
    constexpr int ID_RIGHT_AFT_STEER    {27};
    constexpr int ID_RIGHT_AFT_CANCODER {25};
        
    // Left Aft Swerve Module    
    constexpr int ID_LEFT_AFT_DRIVE     {26};
    constexpr int ID_LEFT_AFT_STEER     {24};
